...
class GyroL3GD20H {
    ...
    static constexpr double GYRO_SENSITIVITY_250DPS  = 0.00875F;  // Roughly 22/256 for fixed point match
    static constexpr double GYRO_SENSITIVITY_500DPS  = 0.0175F;    // Roughly 45/256
    static constexpr double GYRO_SENSITIVITY_2000DPS = 0.070F;      // Roughly 18/256
